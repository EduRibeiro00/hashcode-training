...
###############################################
# Define other temperature functions here:
...
def anealing(init_state: State, num_its: int, temperature_function: function = default_temperature_function,
             initial_temp: float = 90):
    state = init_state
